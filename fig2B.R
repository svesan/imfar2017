...
width = 0.001,
color = "#56B4E9") + scale_y_log10(limits = c(0.3, 400),
                                   breaks = c(0.3, 1, 3, 10, 100, 400)) + ylab("Relative Risk") +
...
last_plot() + theme(axis.title.x=element_text(face="bold", color="#993333", size=18))
